    ...
    <>
      <div className='accountWrap'>
        <div className="dd:h-screen">
          <Logo />
          <div className="grid grid-cols-12 dd:h-screen">
              <div className="px-4 md:px-7 lg:pl-[70px] dd:pl-7 dd:pr-7 lg:pr-12 py-9 flex justify-center flex-col self-stretch col-span-full dd:col-span-5 xl:col-span-4">
              ...
              <div className="col-span-full dd:col-span-7 xl:col-span-8 hidden dd:block">
                <ImagewithLogo />
              </div>
          </div>
